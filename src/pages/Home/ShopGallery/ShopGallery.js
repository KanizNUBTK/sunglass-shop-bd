...
const ShopGallery = () => {
    return (
        <Container sx={{ pb: 5, mb: 5, boxShadow: 1 }}>
            <Typography variant="h4" sx={{ my: 5, py: 5, textAlign: 'center', fontWeight: 600, color:'#1976D2' }} gutterBottom component="div">
                Pictures inside the store
            </Typography>
            <Grid container spacing={{ xs: 2, md: 5 }} columns={{ xs: 4, sm: 8, md: 12 }}>
                <Grid item xs={12} sm={12} md={6} sx={{ p: 5 }}>
                    <Grid>
                        <Typography variant="h6" sx={{ fontWeight: 600, boxShadow: 2, p: 3 }} gutterBottom component="div">
